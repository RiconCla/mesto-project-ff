import { openModal } from './modal.js'
 ...
 export function addCard (card, setDeleteConfirmation, handlerLike, handlerImagePopup, myUserId, modalDeleteCard) {
  //Темплейт карточки
  ...
  cardImage.addEventListener('click', () => handlerImagePopup(card.name, card.link));
  ...
  cardElementLike.addEventListener('click', () => handlerLike(cardElementLike, card._id, cardElementLikeCount));
...
export function updateStateCounterandLike (countLike, cardData, likeButton, myUserId) {
